  ...
  render () {
    return (
      <PanelSelf
        ...
        headerContent={
          <PanelHeadline>
            <PanelTitle>Fire Weather</PanelTitle>
          </PanelHeadline>
        }
        bodyContent={
          <BodyScroll>
            <SummaryExpandable>
              <p>Harnessing NASA’s unique data and models to understand and predict the impacts of new extreme fires in the Earth System</p>
            </SummaryExpandable>
            <InsightsBlock>
              {this.renderContent()}
            </InsightsBlock>
